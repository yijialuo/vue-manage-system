<template>
    <div>
        <div class="table">
            ...
            <div class="container">
                <div v-if="groupId==='doman'||groupId==='jsb_doman'" class="handle-box">
                    <el-button type="primary" icon="el-icon-circle-plus" class="handle-del mr10"
                               @click="xjzblc">
                        新建招标流程
                    </el-button>
                </div>
                <el-table height="600px" stripe :data="clzhaobiaos.slice((currentPage-1)*10,currentPage*10)" border class="table">
        ...
        <el-dialog title="招标流程审批" :visible.sync="show_xq" width="680px">
            <el-form ref="form" label-width="100px">
                <el-form-item label="项目">
                    <el-input style="color:#FF0000;" :disabled="true" v-model="zhaobiao.xmName" rows="6"></el-input>
                </el-form-item>
                <el-form-item label="技术要求备注">
                ...
                <el-form-item label="中标单位">
                    <el-input :disabled="true" v-model="zhaobiao.zbr" ></el-input>
                </el-form-item>
                <el-form-item label="中标金额">
                    <el-input :disabled="true" v-model="zhaobiao.zbje" ></el-input>
                </el-form-item>
